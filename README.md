...
- I've also dealt with lesser known but still officially-supported repositories on the official GitHub TensorFlow project page.  Core I think are the [models](https://github.com/tensorflow/datasets) and [datasets](https://github.com/tensorflow/datasets) directories.  [object_detection](https://github.com/tensorflow/models/blob/master/research/object_detection/) one is cool, [graphics](https://github.com/tensorflow/graphics), [gan](https://github.com/tensorflow/gan), [probability](https://github.com/tensorflow/probability).  **None** of these repositories are covered by the exam.
