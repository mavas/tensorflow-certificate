...
- I've also dealt with lesser known but still officially-supported repositories on the official GitHub TensorFlow project page.  [object_detection](https://github.com/tensorflow/models/blob/master/research/object_detection/), [graphics](https://github.com/tensorflow/graphics), [gan](https://github.com/tensorflow/gan), [datasets](https://github.com/tensorflow/datasets), [probability](https://github.com/tensorflow/probability).  **None** of these repositories are covered by the exam.
